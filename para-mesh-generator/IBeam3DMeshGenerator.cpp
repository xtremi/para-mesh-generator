...
IBeam3DMeshGenerator::IBeam3DMeshGenerator(const std::string& _filepath, format_type _format)
...
*/
void IBeam3DMeshGenerator::writeConnectionElements()
{
	...
	elID = createElementsBetweenCubes(feaWriter, fb1, fb2, Mesh3DCube::edge::edge14, Mesh3DCube::edge::edge23, true, true, elID);
	elID = createElementsBetweenCubes(feaWriter, fb3, fb2, Mesh3DCube::edge::edge23, Mesh3DCube::edge::edge14, true, true, elID);
	elID = createElementsBetweenCubes(feaWriter, ft1, ft2, Mesh3DCube::edge::edge58, Mesh3DCube::edge::edge67, false, false, elID);
	elID = createElementsBetweenCubes(feaWriter, ft3, ft2, Mesh3DCube::edge::edge67, Mesh3DCube::edge::edge58, false, false, elID);
	elID = createElementsBetweenCubes(feaWriter, fb2, w1, Mesh3DCube::edge::edge56, Mesh3DCube::edge::edge12, true, false, elID);
	elID = createElementsBetweenCubes(feaWriter, ft2, w1, Mesh3DCube::edge::edge12, Mesh3DCube::edge::edge56, false, true, elID);
